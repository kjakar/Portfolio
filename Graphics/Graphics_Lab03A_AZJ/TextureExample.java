...
public class TextureExample {
	...
	public static void main(String[] args) {
		...
		megaMan.modelMatrix.setBasis((Matrix4.getScale(5.0f, 5.0f, 0.0f).multiply(Matrix4.getRotation(-90.0f, 0, 0.0f))).multiply(Matrix4.getTranslation(new Vector4(0, 0, 0.0f, 1.0f))));
		...
		while (!window.shouldClose()){
			...
			System.out.println(distance(chestPos, camera.getPosition()));
			if (distance(chestPos, camera.getPosition()) < 1.9f) {
				System.exit(0);
			}
